...
public class JImageEditor extends javax.swing.JPanel {
	...
	private void ScaleButtons() {
		...
		PropertyUtil.ScaleButtonIcon(m_jbtncolor, menuwidth, menuheight, fontsize);
	...
	public void doLoad() {
		...
		fc.addChoosableFileFilter(
				new ExtensionsFilter(LocalRes.getIntString("label.imagefiles"), "png", "gif", "jpg", "jpeg", "bmp"));
	...
	private BufferedImage resizeImage(BufferedImage img) {
		...
		if (scalex < scaley) {
			g2d.drawImage(img, 0, (int) ((myheight - img.getHeight(null) * scalex) / 2.0), mywidth,
					(int) (img.getHeight(null) * scalex), null);
		} else {
	...
	private void initComponents() {
		...
		m_jbtncolor = new javax.swing.JButton();
		...
		m_jbtncolor.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				m_jbtncolorActionPerformed(evt);
			}
		});
		jPanel2.add(m_jbtncolor);
	...
	private void m_jbtncolorActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_m_jbtnopenActionPerformed
	...
	private javax.swing.JButton m_jbtncolor;
