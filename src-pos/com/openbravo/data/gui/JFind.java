...
public class JFind extends JDialog {
	...
	private FindInfo init(AppView app, FindInfo lastFindInfo) throws BasicException {
		m_App = app;
		initComponents();
	...
	public static FindInfo showMessage(AppView app, Component parent, FindInfo lastFindInfo) throws BasicException {
		...
		return myMsg.init(app, lastFindInfo);
	}
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		PropertyUtil.ScaleDialog(this.m_App, this, 434, 222);
