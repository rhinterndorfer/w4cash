...
public class JNumberDialog extends javax.swing.JDialog {
	...
	/** Creates new form JNumberDialog */
	public JNumberDialog(AppView app, java.awt.Dialog parent, boolean modal) {
		super(parent, modal);
		init(app);
	}
	...
	public static Double showEditNumber(AppView app, Component parent, String title) {
		return showEditNumber(app, parent, title, null, null);
	}

	public static Double showEditNumber(AppView app, Component parent, String title, String message) {
		return showEditNumber(app, parent, title, message, null);
	}

	public static Double showEditNumber(AppView app, Component parent, String title, String message, Icon icon) {

		Window window = SwingUtilities.windowForComponent(parent);

		JNumberDialog myMsg;
		if (window instanceof Frame) {
			myMsg = new JNumberDialog(app, (Frame) window, true);
		} else {
			myMsg = new JNumberDialog(app, (Dialog) window, true);
		}
	...
	private void ScaleButtons() {
		...
		int fontsize = Integer.parseInt(PropertyUtil.getProperty(m_App, "Ticket.Buttons", "button-small-fontsize", "16"));
