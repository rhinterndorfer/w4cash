...
public class AttributeSetFilter extends javax.swing.JPanel implements ReportEditorCreator {
	...
	public AttributeSetFilter(AppView app) {
		m_App = app;
		initComponents();
		ScaleButtons();
	}
	...
	public void init(AppView app) {
		...
		attusesent = new StaticSentence(app.getSession(), "SELECT ID, NAME FROM ATTRIBUTESET ORDER BY NAME", null,
				new SerializerRead() {
	...
	private void initComponents() {
		...
		root.add(jAttrSet, gbc_textPane);
