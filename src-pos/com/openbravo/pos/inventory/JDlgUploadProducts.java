...
public class JDlgUploadProducts extends javax.swing.JDialog {
	...
	private void init(AppView app, DeviceScanner scanner, BrowsableEditableData bd) {
		this.m_App = app;
		initComponents();
	...
	public static void showMessage(AppView app, Component parent, DeviceScanner scanner, BrowsableEditableData bd) {
	...
	private void initComponents() {
		...
		PropertyUtil.ScaleDialog(m_App, this, 474, 161);
	...
	private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jcmdOKActionPerformed
		...
		try {
			...
			for (int i = 0; i < l.getSize(); i++) {
				...
				m_scanner.sendProduct((String) myprod[3], // name
