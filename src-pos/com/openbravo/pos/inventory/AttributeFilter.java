...
public class AttributeFilter extends javax.swing.JPanel implements ReportEditorCreator {
	...
	public AttributeFilter(AppView app) {
		m_App = app;
		initComponents();
		ScaleButtons();
	}
	...
	public void init(AppView app) {
		...
		attsent = new StaticSentence(app.getSession(), "SELECT ID, NAME FROM ATTRIBUTE ORDER BY NAME", null,
				new SerializerRead() {
	...
	private void initComponents() {
		...
		// .addComponent(jAttr, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
		// javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	public void ScaleButtons() {
		...
		PropertyUtil.ScaleComboFontsize(m_App, jAttr, "common-small-fontsize", "32");
	}
