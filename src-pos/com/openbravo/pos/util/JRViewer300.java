...
public class JRViewer300 extends javax.swing.JPanel implements JRHyperlinkListener {
	 ...
	 * {@link JRViewer300 JRViewer300} to render a report page.
	 * <p>
	 * If rendering a report page would require an image larger than this
	 * threshold (i.e. image width x image height > maximum size), the report
	 * page will be rendered directly on the viewer component.
	 * </p>
	 * <p>
	 * If this property is zero or negative, buffered images will never be user
	 * to render a report page. By default, this property is set to 0.
	 * </p>
	 */
	...
	public JRViewer300(AppView app, String fileName, boolean isXML) throws JRException {
		this(app, fileName, isXML, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, InputStream is, boolean isXML) throws JRException {
		this(app, is, isXML, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, JasperPrint jrPrint) {
		this(app, jrPrint, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, String fileName, boolean isXML, Locale locale) throws JRException {
		this(app, fileName, isXML, locale, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, InputStream is, boolean isXML, Locale locale) throws JRException {
		this(app, is, isXML, locale, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, JasperPrint jrPrint, Locale locale) {
		this(app, jrPrint, locale, null);
	}

	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, String fileName, boolean isXML, Locale locale, ResourceBundle resBundle)
			throws JRException {
		m_app = app;
	...
	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle)
			throws JRException {
		m_app = app;
	...
	/** Creates new form JRViewer300 */
	public JRViewer300(AppView app, JasperPrint jrPrint, Locale locale, ResourceBundle resBundle) {
		m_app = app;
	...
	private void initComponents() {
		...
		btnReload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/refresh.png"))); // NOI18N
		...
		btnFirst.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/22leftarrow.png"))); // NOI18N
		...
		btnPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/leftarrow.png"))); // NOI18N
		...
		btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/rightarrow.png"))); // NOI18N
		...
		btnLast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/22rightarrow.png"))); // NOI18N
	...
	private void ScaleButtons() {
		int menuwidth = Integer.parseInt(PropertyUtil.getProperty(m_app, "Ticket.Buttons", "menubar-img-width", "48"));
		int menuheight = Integer
				.parseInt(PropertyUtil.getProperty(m_app, "Ticket.Buttons", "menubar-img-height", "48"));
		int fontsize = Integer
				.parseInt(PropertyUtil.getProperty(m_app, "Ticket.Buttons", "button-small-fontsize", "16"));

		PropertyUtil.ScaleButtonIcon(btnFirst, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnLast, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnNext, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnPrevious, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnPrint, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnReload, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnSave, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnZoomIn, menuwidth, menuheight, fontsize);
		PropertyUtil.ScaleButtonIcon(btnZoomOut, menuwidth, menuheight, fontsize);

		PropertyUtil.ScaleLabelFontsizePrefered(m_app, lblPage, "common-small-fontsize", "32");
		PropertyUtil.ScaleLabelFontsizePrefered(m_app, lblStatus, "common-small-fontsize", "32");
		PropertyUtil.ScaleComboFontsizePrefered(m_app, cmbZoom, "common-small-fontsize", "32");

		PropertyUtil.ScaleTextFieldFontsizePrefered(m_app, txtGoTo, "common-small-fontsize", "32");

		if (btnActualSize != null) {
			PropertyUtil.ScaleButtonIcon(btnActualSize, menuwidth, menuheight, fontsize);
		}
		if (btnFitPage != null) {
			PropertyUtil.ScaleButtonIcon(btnFitPage, menuwidth, menuheight, fontsize);
		}
		if (btnFitWidth != null) {
			PropertyUtil.ScaleButtonIcon(btnFitWidth, menuwidth, menuheight, fontsize);
		}
	}
			...
			for (Iterator it = elements.iterator(); it.hasNext();) {
				...
				if (hasHyperlink || hasImageMap || hasTooltip) {
					...
					if (toolTip == null && hasImageMap) {
						toolTip = "";// not null to register the panel as having
										// a tool tip
					}
	...
	protected class ImageMapPanel extends JPanel implements MouseListener, MouseMotionListener {
		...
		protected JRPrintImageAreaHyperlink getImageMapArea(int x, int y) {
			...
			if (imageAreaHyperlinks != null) {
				for (ListIterator it = imageAreaHyperlinks.listIterator(imageAreaHyperlinks.size()); image == null
						&& it.hasPrevious();) {
	...
	*/
	...
	protected void paintPage(Graphics2D grx) {
		...
		try {
			...
			exporter.setParameter(JRExporterParameter.OFFSET_X, new Integer(1)); // lblPage
																					// border
	...
	private void upNavigate(KeyEvent evt) {
		if ((scrollPane.getViewport().getHeight() > pnlPage.getHeight()
				|| scrollPane.getVerticalScrollBar().getValue() == 0) && pageIndex > 0) {
			setPageIndex(pageIndex - 1);
			if (scrollPane.isEnabled())
