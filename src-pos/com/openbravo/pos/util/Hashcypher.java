...
public class Hashcypher {
	...
	public static String changePassword(AppView app, Component parent) {
		// Show the changePassword dialogs but do not check the old password

		String sPassword = JPasswordDialog.showEditPassword(app, parent, AppLocal.getIntString("Label.Password"),
				AppLocal.getIntString("label.passwordnew"),
				new ImageIcon(Hashcypher.class.getResource("/com/openbravo/images/password.png")));
		if (sPassword != null) {
			String sPassword2 = JPasswordDialog.showEditPassword(app, parent, AppLocal.getIntString("Label.Password"),
	...
	public static String changePassword(AppView app, Component parent, String sOldPassword) {
		...
		if (sPassword != null) {
			if (Hashcypher.authenticate(sPassword, sOldPassword)) {
				return changePassword(app, parent);
			} else {
