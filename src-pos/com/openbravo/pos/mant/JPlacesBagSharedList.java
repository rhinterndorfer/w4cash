...
public class JPlacesBagSharedList extends javax.swing.JDialog {
	...
	/** Creates new form JTicketsBagSharedList */
	private JPlacesBagSharedList(java.awt.Dialog parent, boolean modal) {
		super(parent, modal);
	}
	...
	public static JPlacesBagSharedList newJDialog(JPlacesBagShared ticketsbagshared) {
		...
		if (window instanceof Frame) {
			mydialog = new JPlacesBagSharedList((Frame) window, true);
		} else {
		...
		public JButtonTicket(SharedTicketInfo ticket) {
			...
			addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					...
					// y oculto la ventana
					JPlacesBagSharedList.this.setVisible(false);
				}
			});
