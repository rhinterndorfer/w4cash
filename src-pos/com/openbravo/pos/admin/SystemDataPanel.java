 ...
 * @author adrianromero
 */
public class SystemDataPanel extends JPanel implements JPanelView {
    ...
    public SystemDataPanel(AppView oApp) {
        this(oApp.getProperties(), oApp);  
    }
    
    public SystemDataPanel(AppProperties props, AppView oApp) {
        ...
        m_panelconfig.add(new JPanelSystemData(oApp));
    ...
    public String getTitle() {
        return AppLocal.getIntString("Menu.Systemdata");
    } 
