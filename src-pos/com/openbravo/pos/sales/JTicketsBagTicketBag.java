...
public class JTicketsBagTicketBag extends javax.swing.JPanel {
	...
	private void ScaleButtons() {
		int btnWidth = Integer.parseInt(PropertyUtil.getProperty(m_ticketsbagticket.getApp(), "Ticket.Buttons",
				"button-touchlarge-width", "60"));
		int btnHeight = Integer.parseInt(PropertyUtil.getProperty(m_ticketsbagticket.getApp(), "Ticket.Buttons",
				"button-touchlarge-height", "60"));

		int fontsize = Integer.parseInt(
				PropertyUtil.getProperty(m_ticketsbagticket.getApp(), "Ticket.Buttons", "button-large-fontsize", "16"));
