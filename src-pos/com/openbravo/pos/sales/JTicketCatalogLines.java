...
public class JTicketCatalogLines extends javax.swing.JPanel {
	...
	public JTicketCatalogLines(AppView app, JPanelTicketEdits jTicketEdit, boolean pricevisible, boolean taxesincluded,
			int widthProduct, int heightProduct, int widthCategory, int heightCategory, int productFontsize,
		...
		m_catalog = new JCatalog(app, dlSales, pricevisible, taxesincluded, widthProduct, heightProduct, widthCategory,
				heightCategory, productFontsize, categoryFontsize);
