...
public class JTicketCatalogLines extends javax.swing.JPanel {
    ...
    public JTicketCatalogLines(AppView app, JPanelTicketEdits jTicketEdit, boolean pricevisible, boolean taxesincluded, int widthProduct, int heightProduct, int widthCategory, int heightCategory) {
