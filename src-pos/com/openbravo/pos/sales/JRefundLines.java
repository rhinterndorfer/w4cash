...
public class JRefundLines extends javax.swing.JPanel {
	...
	public JRefundLines(AppView app, DataLogicSystem dlSystem, JPanelTicketEdits jTicketEdit) {
		m_App = app;
		m_jTicketEdit = jTicketEdit;

		initComponents();

		ticketlines = new JTicketLines(app, "sales-producttable-lineheight", "sales-producttable-fontsize",
