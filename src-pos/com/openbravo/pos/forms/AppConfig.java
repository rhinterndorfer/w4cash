...
public class AppConfig implements AppProperties {
	...
	public String getProperty(String sKey) {
		String value = m_propsconfig.getProperty(sKey);
	...
	private void loadDefault() {
		...
		m_propsconfig.setProperty("db.URL", "jdbc:derby:"
				+ new File(new File(System.getProperty("user.home")), AppLocal.APP_ID + "-database").getAbsolutePath()
				+ ";create=true");
		...
		m_propsconfig.setProperty("machine.screenmode", "window"); // fullscreen
																	// / window
