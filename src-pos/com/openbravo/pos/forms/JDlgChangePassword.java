...
public class JDlgChangePassword extends javax.swing.JDialog {
	...
	private String init(AppView app, String sOldPassword) {
		this.m_App = app;
		initComponents();
	...
	public static String showMessage(AppView app, Component parent, String sOldPassword) {
		...
		return myMsg.init(app, sOldPassword);
	}
	...
	private void initComponents() {
		...
		PropertyUtil.ScaleDialog(m_App, this, 416, 205);
		...
		if (new String(jtxtPasswordNew.getPassword()).equals(new String(jtxtPasswordRepeat.getPassword()))) {
			if (Hashcypher.authenticate(new String(jtxtPasswordOld.getPassword()), m_sOldPassword)) {
				...
				JMessageDialog.showMessage(m_App,this,
						new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.BadPassword")));
			}
		} else {
			JMessageDialog.showMessage(m_App,this,
					new MessageInf(MessageInf.SGN_WARNING, AppLocal.getIntString("message.changepassworddistinct")));
		}
