...
public class JPanelSQL extends JPanel implements JPanelView {
	...
	public JPanelSQL(AppView oApp) {
		...
		// DefaultMutableTreeNode(AppLocal.APP_NAME);

		SQLDatabase db = new SQLDatabase(AppLocal.APP_NAME + " - Database.");

		try {
			BaseSentence sent = new MetaSentence(m_App.getSession(), "getTables",
					new SerializerWriteBasic(new Datas[] { Datas.STRING, Datas.STRING }), new SerializerReadBasic(
	...
	/*
	 * private void insertProductCategories() { try { for( int i = 100; i <
	 * 50000; i++) { String sentence = "INSERT INTO m_product_category(" +
	 * " m_product_category_id," + " ad_client_id," + " ad_org_id," +
	 * " isactive, " + " created, createdby, " + " updated, updatedby, " +
	 * " value, " + " name, " + " description, " +
	 * " isdefault, plannedmargin, a_asset_group_id) VALUES " + "(" +
	 * Integer.toString(i + 1000000) + " ," + " 1000000, " + " 0, " + "'Y', " +
	 * " '2007-01-01', 100, " + " '2007-01-01', 100, " +
	 * " 'Fictious Category no " + Integer.toString(i) +"' ," +
	 * " 'Fictious Category Name no " + Integer.toString(i) +"' ," + " null," +
	 * " 'N'," + " 0," + " null)"; System.out.println(i);
	 * System.out.println(sentence); BaseSentence sent = new
	 * StaticSentence(m_App.getSession(), sentence); sent.exec(); } } catch
	 * (BasicException e) { e.printStackTrace(); } }
	 */
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		// "getTables", new SerializerWriteBasic(new Datas[] {Datas.STRING,
		// Datas.STRING}), null);
		// BaseSentence sent = new MetaSentence(m_App.getConnection(),
		// "getColumns", new SerializerWriteBasic(new Datas[] {Datas.STRING,
		// Datas.STRING, Datas.STRING}), null);
