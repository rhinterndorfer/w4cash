...
-- Database upgrade script for ORACLE 2.45.3 -> 2.45.4

alter table ATTRIBUTEVALUE add LINENO NUMBER(38,0);
...
UPDATE APPLICATIONS SET NAME = 'w4cashdb', VERSION = '2.45.4' WHERE ID = 'w4cashdb' AND DBServerName = SYS_CONTEXT('USERENV', 'SERVER_HOST');

INSERT INTO LOGS (logtime, loghost, loglevel, logmessage) 
values (sysdate, SYS_CONTEXT('USERENV', 'SERVER_HOST'), 'INFO', 'Update to version ' || '2.45.4');
