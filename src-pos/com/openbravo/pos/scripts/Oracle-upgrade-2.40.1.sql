...
-- Database upgrade script for ORACLE 2.40.1 -> 2.40.2
...
-- resources
UPDATE RESOURCES SET CONTENT=$FILE{/com/openbravo/pos/templates/Ticket.Line.xml} WHERE NAME='Ticket.Line';
UPDATE RESOURCES SET CONTENT=$FILE{/com/openbravo/pos/templates/Menu.Root.txt} WHERE NAME='Menu.Root';
DELETE FROM RESOURCES WHERE NAME='Reports.Address';
...
UPDATE APPLICATIONS SET NAME = 'w4cashdb', VERSION = '2.40.2' WHERE ID = 'w4cashdb';
