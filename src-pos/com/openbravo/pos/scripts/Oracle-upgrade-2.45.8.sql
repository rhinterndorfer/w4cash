...
-- Database upgrade script for ORACLE 2.45.8 -> 2.45.9

ALTER TABLE SHAREDTICKETS ADD STATE VARCHAR2(256);

CREATE TABLE TICKETS_IMAGE (
	"ID" VARCHAR2(256 BYTE) NOT NULL,
	"PAGE" NUMBER NOT NULL,
	"MIME" VARCHAR2(256) NOT NULL,
	"CONTENTBASE64" CLOB NOT NULL
);

ALTER TABLE TICKETS_IMAGE ADD CONSTRAINT PK_TICKETS_IMAGE PRIMARY KEY ("ID","PAGE");
...
UPDATE APPLICATIONS SET NAME = 'w4cashdb', VERSION = '2.45.9' WHERE ID = 'w4cashdb' AND DBServerName = SYS_CONTEXT('USERENV', 'SERVER_HOST');
