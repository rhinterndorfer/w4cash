...
-- V2.45.1 (set in line 34!!!)

CREATE TABLE APPLICATIONS (
    ID VARCHAR2(256) NOT NULL,
    NAME VARCHAR2(1024) NOT NULL,
    VERSION VARCHAR2(1024) NOT NULL,
    DBSERVERNAME VARCHAR2(256),
    POSID VARCHAR2(256),
    AESBASE64 VARCHAR2(1024),
    PRIMARY KEY (ID, DBSERVERNAME)
);

INSERT INTO APPLICATIONS(ID, NAME, VERSION, DBSERVERNAME) VALUES($APP_ID{}, $APP_NAME{}, $APP_VERSION{}, SYS_CONTEXT('USERENV', 'SERVER_HOST'));
INSERT INTO APPLICATIONS(ID, NAME, VERSION, DBSERVERNAME) VALUES('w4cashdb', 'w4cashdb', '2.45.1', SYS_CONTEXT('USERENV', 'SERVER_HOST'));
...
CREATE TABLE STOCKDIARY (
    ...
    STOCKTACKINGID VARCHAR2(256),
    STOCKMOVEMENTID VARCHAR2(256),
    PRIMARY KEY (ID),
...
CREATE TABLE STOCKTACKINGITEMS (
    ...
    ACTUALSTOCK DOUBLE PRECISION NULL,
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETS (
    ...
    SIGNATUREID VARCHAR2(256),
	SIGNATUREVALUE BLOB,
	CASHSUMCOUNTER DOUBLE PRECISION,
	CASHTICKETID INTEGER,
	ALGORITHMID INTEGER,
	POSID VARCHAR2(256),
	SIGNATUREOUTOFORDER INTEGER,
	CHAINVALUE BLOB,
	CASHSUMCOUNTERENC BLOB,
	VALIDATION INTEGER,
	MONTH INTEGER,
    PRIMARY KEY (ID),
...
CREATE INDEX TICKETS_TICKETTYPE_TICKETID ON TICKETS(TICKETTYPE,TICKETID);
CREATE INDEX TICKETS_TYPE_CASHTICKETID ON TICKETS(TICKETTYPE,CASHTICKETID);
...
CREATE TABLE RESERVATIONS (
    ...
    DESCRIPTION VARCHAR2(1024),
    DATETILL TIMESTAMP DEFAULT TO_DATE('2999-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS') NOT NULL,
    PRIMARY KEY (ID)
);
