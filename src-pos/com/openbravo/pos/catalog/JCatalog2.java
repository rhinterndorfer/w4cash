...
public class JCatalog2 extends JPanel implements /* ListSelectionListener, */ CatalogSelector {
	...
	public JCatalog2(AppView app, DataLogicSales dlSales) {
		this(app, dlSales, false, false, 64, 54, 32, 32);
	}

	public JCatalog2(AppView app, DataLogicSales dlSales, boolean pricevisible, boolean taxesincluded, int widthProduct,
