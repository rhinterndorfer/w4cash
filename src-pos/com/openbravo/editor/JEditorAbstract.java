...
<<<<<<< HEAD
	...
	private final Border m_borderinactive = new javax.swing.border.CompoundBorder(
			new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")),
			new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4)));
=======
...
>>>>>>> branch 'master' of https://github.com/rhinterndorfer/w4cash/
	...
	public void setEnabled(boolean b) {
		...
		panBackground.setBackground(b ? javax.swing.UIManager.getDefaults().getColor("TextField.background")
				: javax.swing.UIManager.getDefaults().getColor("TextField.disabledBackground"));
		super.setEnabled(b);
	}
	...
	public Font getBFont() {
		return this.m_jText.getFont();
	}

	public void setBFont(Font font) {
		this.m_jText.setFont(font);
	}
	...
	public void setBSize(int width, int height) {
		...
		m_jText.setMinimumSize(new java.awt.Dimension(width, height));
		m_jText.setPreferredSize(new java.awt.Dimension(width, height));
