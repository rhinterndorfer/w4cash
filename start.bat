...
set CP="%DIRNAME%w4cash.jar"

set CP=%CP%;"%DIRNAME%lib/joda-time-2.4.jar"
set CP=%CP%;"%DIRNAME%lib/jcommon-1.0.23.jar"
set CP=%CP%;"%DIRNAME%lib/jfreechart-1.0.19.jar"
set CP=%CP%;"%DIRNAME%lib/jdt-compiler-3.1.1.jar"
set CP=%CP%;"%DIRNAME%lib/commons-beanutils-1.9.2.jar"
set CP=%CP%;"%DIRNAME%lib/commons-digester-2.1.jar"
set CP=%CP%;"%DIRNAME%lib/jasperreports-6.2.0.jar"
set CP=%CP%;"%DIRNAME%lib/jasperreports-fonts-6.2.0.jar"
set CP=%CP%;"%DIRNAME%lib/jasperreports-functions-6.2.0.jar"
set CP=%CP%;"%DIRNAME%lib/jasperreports-javaflow-6.2.0.jar"
set CP=%CP%;"%DIRNAME%lib/iText-2.1.7.jar"
set CP=%CP%;"%DIRNAME%lib/poi-3.13-20150929.jar"
set CP=%CP%;"%DIRNAME%lib/barcode4j-light.jar"
set CP=%CP%;"%DIRNAME%lib/commons-codec-1.3.jar"
set CP=%CP%;"%DIRNAME%lib/velocity-1.7.jar"
set CP=%CP%;"%DIRNAME%lib/oro-2.0.8.jar"
set CP=%CP%;"%DIRNAME%lib/commons-collections-3.2.2.jar"
set CP=%CP%;"%DIRNAME%lib/commons-lang-2.6.jar"
...
set CP=%CP%;"%DIRNAME%lib/commons-discovery-0.5.jar"
